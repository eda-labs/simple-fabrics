...
def test_routed_interface_schema_sanity():
    ...
    assert routed_interface_schema.version == "v1alpha1"
...
def test_vnet_schema_sanity():
    ...
    assert vnet_schema.version == "v1alpha1"
...
def test_bd_schema_sanity():
    ...
    assert bd_schema.version == "v1alpha1"
...
def test_router_schema_sanity():
    ...
    assert router_schema.version == "v1alpha1"
...
def test_router_attachment_schema_sanity():
    ...
    assert router_attachment_schema.version == "v1alpha1"
